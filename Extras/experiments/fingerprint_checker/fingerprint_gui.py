...
from Extras.experiments.fingerprint_checker.fingerprint_analyses import (  # noqa: E402
    find_nearest_match,
)
from Extras.experiments.fingerprint_checker.fingerprint_cache import (  # noqa: E402
    DEFAULT_CACHE_DIR, clear_cache,
)
from Extras.experiments.fingerprint_checker.fingerprint_io import (  # noqa: E402
    load_sample_image_by_row,
)
from Extras.experiments.fingerprint_checker.fingerprint_orchestrator import (  # noqa: E402
    AllChecksResult, run_all_checks,
)
from Extras.experiments.fingerprint_checker.fingerprint_plots import (  # noqa: E402
...
from Extras.experiments.fingerprint_checker.fingerprint_report import write_full_report  # noqa: E402
...
class FingerprintCheckerApp(tk.Tk):
    ...
    def _populate_report_tab(self, result: AllChecksResult):
        ...
        from Extras.experiments.fingerprint_checker.fingerprint_report import write_markdown_report
